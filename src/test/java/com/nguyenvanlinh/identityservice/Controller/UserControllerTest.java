...
// isolation trong unitTest - Unit test mà không cần start framework
@TestPropertySource("/test.properties") // connect h2database là test.properties chứ kh phải mySySQL trong application.yaml
    ...
    void createUser_validRequest_success() throws Exception {
        ...
        ResultActions resultActions = mockMvc.perform(post("/users")
                ...
                .andExpect(jsonPath("result.id")
                        .value("cf0600f538b3"))
                .andExpect(jsonPath("result.username")
                        .value("saocunqduoc"))
                .andExpect(jsonPath("result.firstname")
                        .value("Admin"))
                .andExpect(jsonPath("result.lastname")
                        .value(""))
                .andExpect(jsonPath("result.dob")
                        .value(LocalDate.of(2003, 3, 6))
